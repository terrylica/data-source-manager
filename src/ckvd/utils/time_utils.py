...
compatibility. New code should import directly from ckvd.utils.time.
...
Example:
    >>> from ckvd.utils.time_utils import align_time_boundaries, datetime_to_milliseconds
