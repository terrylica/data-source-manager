...
from data_source_manager.utils.config import LOG_SEARCH_WINDOW_SECONDS
...
def display_results(
    ...
    if "_data_source" in df.columns:
        ...
        date_groups = df.pivot_table(index="date", columns="_data_source", aggfunc="size", fill_value=0)
