...
- **rename:** Package renamed from data-source-manager to crypto-kline-vision-data.
  ...
  - Class: `DataSourceManager` → `CryptoKlineVisionData`
  - Config: `DataSourceConfig` → `CKVDConfig`
  - Logger: `DSMLogger` → `CKVDLogger`
  - Env vars: `DSM_*` → `CKVD_*`
  - Cache: `~/.cache/data_source_manager` → `~/.cache/crypto-kline-vision-data`
  - No backward compatibility shim.
...
- **dsm:** complete feature phases 4-5 with OKX provider and parallel fetching ([d83dd16](https://github.com/terrylica/data-source-manager/commit/d83dd16f9fb2f93ff4a2a20c992608c6cd82a2e0))
...
- **init:** add type annotation to **getattr** (ANN001/ANN202) ([a86763b](https://github.com/terrylica/data-source-manager/commit/a86763bed079913b6087638f36e1b75b87f780c9))
