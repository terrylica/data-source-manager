...
**Summary**: Comprehensive Claude Code infrastructure implemented with 251 commits.

| Metric              | Value                                                                            |
| ------------------- | -------------------------------------------------------------------------------- |
| Design spec lines   | 39933                                                                            |
| Sections            | 264                                                                              |
...
- Hooks reference (events, configuration, matchers, exit codes, environment variables)
- Subagent orchestration (scopes, frontmatter, tools, permissions, patterns, DSM agents)
- Prompt engineering (Claude 4.x best practices, XML tags, tool usage, state management)
- Skills architecture (SKILL.md structure, frontmatter, imports, rules, progressive disclosure)
- Settings & permissions (hierarchy, allow/deny/ask rules, patterns, enterprise managed settings)
- Agentic coding best practices (explore-plan-code-commit, verification, context management, patterns)
- MCP server configuration detailed (transports, scopes, tool search, managed config, enterprise)
- Common workflows reference (exploration, debugging, refactoring, testing, PR, docs, images, sessions)
- Interactive mode reference (shortcuts, vim mode, terminal config, bash mode, background tasks)
- CLI reference and checkpointing (flags, commands, rewind, session management, automation)
- Context window and cost management (token tracking, auto-compaction, optimization strategies)
- Status line configuration (JSON input, scripts, colors, third-party tools, DSM example)
...
- Extended thinking reference (budget tokens, streaming, tool use, interleaved, caching, DSM patterns)
